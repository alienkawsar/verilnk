...
router.delete('/workspaces/:id', async (req, res) => {
    try {
        ...
        await logEnterpriseAdminActionIfApplicable(req, client_1.AuditActionType.DELETE, 'Workspace', `WORKSPACE_DELETED workspaceId=${id}`, id);
